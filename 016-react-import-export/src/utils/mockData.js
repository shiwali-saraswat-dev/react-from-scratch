...
const restaurantsList = [
  {
    ...
    resName: "Sagar",
    cuisine: ["Dum Biryani", "Veg Biryani", "Chiken Biryani"],
    price: 250,
    rating: 4.1,
    time: 45,
  },
  ...
  },
  {
    ...
    resName: "Bistro 57",
    cuisine: ["Aalu Tikki Burger", "Veg Surprize Burger", "Fast Food"],
    price: 200,
    rating: 4.4,
    time: 28,
  },
  {
    ...
    cuisine: ["Vanilla Cake", "Pineapple Cake", "Bakery Items"],
    price: 350,
    rating: 3.9,
    time: 40,
  },
  {
    ...
    cuisine: ["Veg Roll", "Paneer Tikka Roll", "Fast Food"],
    price: 299,
    rating: 4.9,
    time: 25,
  },
